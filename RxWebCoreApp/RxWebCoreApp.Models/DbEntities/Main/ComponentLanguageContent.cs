...
using RxWebCoreApp.Models.Enums.Main;
using RxWebCoreApp.BoundedContext.SqlContext;
namespace RxWebCoreApp.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(RxWebCoreApp.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(RxWebCoreApp.Models.Main.LanguageContent.ComponentLanguageContents))]
